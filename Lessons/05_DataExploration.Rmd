...
print gageplot
#print function works well with markdown documents. 
...
ggplot(USGS.flow.data) +
  ...
  geom_freqpoly(aes(x = gage.height.min), bins = 50, color = "coral") +
...
#boxplots wont show differences in sample sizes
...
> Answer: 
Bar plot: Visualize count data for categorical variables. 
Histogram: Visualize distributions of values for continuous numerical variables
Frequency polygon: Similar to histograms, but instead of displaying bars,  counts of continuous variables are displayed as lines. This is advantageous if you want to display multiple variables or categories of variables at once.
Box and whisker: Similar to histograms, but displaying IQR, median, outliers
Violin: Displays density distributions, somewhat like a hybrid of the box-and-whiskers and the frequency polygon plot.
Scatterplot: Visualize relationships between continuous numerical variables.
## Ending discussion
