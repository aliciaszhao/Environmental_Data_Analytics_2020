...
ui <- fluidPage(theme = shinytheme("yeti"),
  # Choose a title
  titlePanel("Nutrient Levels in Peter and Paul Lake"),
  sidebarLayout(
    sidebarPanel(
