...
#For a given day at a given spot, have total amount of litter that was collected
...
#plot ID is significant predcotr of dry mass. 

# Format ANOVA as lm
Litter.Totals.anova2 <- lm(data = Litter.Totals, dryMass ~ plotID)
summary(Litter.Totals.anova2)

#shows estimate for mean for each individual group. 
...
#both functional and nlcd class are predictors of drymass. 
  ...
  theme(axis.text.x = element_text(angle = 45, hjust = 1)) +
    stat_summary(geom = "text", fun.y = max, vjust = -1, size = 3.5,
               label = c("d", "d", "d", "a", "d", "d","d", "d",
                         "d", "d", "d", "b", "d","d","d", "d",
                         "d", "d", "cd", "bc", "d", "d", "d", "d"), position=position_dodge2(.8)) + 
