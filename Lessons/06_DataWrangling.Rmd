...
> Add notes here: We would be interested in examining these factors to get a baseline and see how they are changing over time. 
...
# R also rearranges row numbers when you use 'arrange'
# Exercise: 
