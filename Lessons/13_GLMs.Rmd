...
#Supposes that lake may have diff intercept but follow same slope. 
# PEter Lake will be 284 PLUS 66. 
...
# Marginal R2 is fixed effects, Conditional is adding in random effects
...
#significant predictor may not be environmentally relevant 
...
> ANSWER: Accounting for the effects of lakes, temperature increases with year in northern Wisconsin (ANCOVA)
