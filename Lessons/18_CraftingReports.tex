...
\item
  Stpre \emph{code}, \emph{visualizations}, and \emph{text} in one place
\item
  Allows you to see the product of your code when knitted into a pdf
\item
  Well formatted, looks neat/clean, good to share with
  others/collaborate
\item
  You can choose which chunks of code to run, allows flexibility
  (managing change/reproducible pipeline)
\item
  Helps \textbf{organize} our code and add notes.
\end{itemize}
...
EPA air datasets in NC for PM2.5, O3 2018-2019\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.58\columnwidth}\raggedright
NEON\_NIWO\_Litter\_mass\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Trap data for litter and small woody debris 2016-2019.\strut
\end{minipage}\tabularnewline
\begin{minipage}[t]{0.58\columnwidth}\raggedright
NTL\_LTER\strut
\end{minipage} & \begin{minipage}[t]{0.36\columnwidth}\raggedright
Lake nutrients dataset\strut
\end{minipage}\tabularnewline
\bottomrule
\end{longtable}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{NTL.Lake.Nutrients.filtered <-}\StringTok{ }\NormalTok{NTL.Lake.Nutrients }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{select}\NormalTok{(}\OperatorTok{-}\KeywordTok{c}\NormalTok{(lakeid, depth_id,comments)) }\OperatorTok{%>%}
...
\caption{Summary of Total Nitrogen}\tabularnewline
\toprule
lakename & Mean.Nitrogen & Min.Nitrogen & Max.Nitrogen &
SD.Nitrogen\tabularnewline
\midrule
\endfirsthead
\toprule
lakename & Mean.Nitrogen & Min.Nitrogen & Max.Nitrogen &
...
\begin{longtable}[]{@{}lrrrr@{}}
\caption{Summary of Total Phosphorus}\tabularnewline
\toprule
lakename & Mean.Nitrogen & Min.Nitrogen & Max.Nitrogen &
SD.Nitrogen\tabularnewline
\midrule
...
\includegraphics{18_CraftingReports_files/figure-latex/unnamed-chunk-4-1.pdf}

\begin{verbatim}
## Warning: Removed 7 rows containing missing values (geom_point).
\end{verbatim}

\begin{flushleft}\includegraphics{18_CraftingReports_files/figure-latex/unnamed-chunk-5-1} \end{flushleft}
...
\emph{Phosphorous and nitrogen concentrations vary by lake; the
difference is especially pronounced in 1997 between East Long Lake, West
Long Lake, Peter LAke, versus Paul Lake and Tuesday Lake. East Long Lake
consistently has higher concentrations compared to the other lakes over
most of the years.}

\begin{center}\rule{0.5\linewidth}{\linethickness}\end{center}

\emph{To better undrstand the relationship, I would want to run a
two-way ANOVA looking at year and lake, and run a post-hoc analysis to
see which lakes/years are different.}
