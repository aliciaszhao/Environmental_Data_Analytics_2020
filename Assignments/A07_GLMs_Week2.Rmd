...
#4
NTL.July.omit <- na.omit(NTL.July)

Temp_AIC <- lm(data = NTL.July.omit, temperature_C ~ year4 + daynum + 
              depth)
step(Temp_AIC)

#The AIC test recommends that we keep all variables. 

Tempmodel <- lm(data = NTL.July.omit, temperature_C~year4 + daynum + depth)
summary(Tempmodel)
...
> Answer: The final set of explanatory variables are year, day number, and depth. This explains approximately 74% of the observed variation in temperature. 
