...
> Answer: We do not use the piecewise constant, because values seem to be gradually changing over time. We do not use the spline interpolation because the data do not appear to have a cubic relationship, and there is the potential issue of overshooting. 
...
> Answer: Ozone concentration seems to display a significant seasonal trend, according to the line graph of the data, as well as the decomposed time series. This makes the SMK test most appropriate, as it accounts for seasonality. 
